<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditEmployee.aspx.cs" Inherits="Travel_Management.EditEmployee" %>
...
<script src="Controllers/EditEmployee.js"></script>
			...
			<div class="card">
				...
				<div class="card-content collapse show">
					<div class="card-body">
						...
						<form class="form" onSubmit="updateNewEmployee(); return false;">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" id="EmpEmail" class="form-control" placeholder="E-mail" name="EmpEmail" required="required">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="projectinput4">Contact Number</label>
											<input type="text" id="EmpPhone" class="form-control" placeholder="Phone" name="EmpPhone" required="required">
										</div>
									</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-2">
			                            ...
			                            <%--<input type="date"  class="form-control"  data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Travel Date">--%>
                                         <input type="password" class="form-control animate" id="Password" placeholder="New Password..." required="required">
			                        </div>
